...
use actix_web::{cookie::Cookie, dev::{Response, Service, ServiceRequest, ServiceResponse, Transform}, error::ErrorUnauthorized, Error};
    ...
    B: 'static,
{
    ...
    fn call(&self, req: ServiceRequest) -> Self::Future {
        ...
        let cookie = req.cookie("token")
            .unwrap_or_else(|| Cookie::new("token", ""));
